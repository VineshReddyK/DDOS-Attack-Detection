"""
Ensemble predictor — weighted majority vote across all loaded models.
Weights are tuned based on CIC-DDoS2019 held-out validation performance.
"""
import numpy as np
import logging
...
class EnsemblePredictor:
    ...
    def predict(self, X: np.ndarray, y_dummy: Optional[np.ndarray] = None) -> np.ndarray:
        ...
        return (normalized_votes > 0.5).astype(int)
